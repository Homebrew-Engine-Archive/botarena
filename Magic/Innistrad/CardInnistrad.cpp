		...
		Power(+0), Life(+0))
{
	...
	cpAbility->SetContextFunction(TriggeredAbility::ContextFunction(this, &CClaustrophobiaCard::SetTriggerContext));

	AddAbility(cpAbility.GetPointer());
}

bool CClaustrophobiaCard::SetTriggerContext(CTriggeredTapCardAbility::TriggerContextType& triggerContext,
												CZone* pFromZone, CZone* pToZone, CPlayer* pByPlayer, MoveType moveType) const
{
